...
**Gender, Equity, and Social Inclusion (GESI)** emphasizes intentional efforts to ensure inclusive and equitable vaccine access. While the technical focus of FSP remains unchanged, integrating a GESI lens ensures the use of disaggregated data, representative team composition, and responsiveness to underserved groups. This improves assumption accuracy and planning effectiveness, without shifting FSP responsibility toward service delivery.
"""
"""
